...
angular.module('openDeskApp.sites').factory('siteProjectDepartmentService', function ($http, $window, alfrescoNodeUtils, userService, documentService, siteService) {
    var restBaseUrl = '/alfresco/s/api/';

    return {


        // todo remove methods and resuse from siteService - like getSiteMembers : function (siteShortname ) return siteService.getSiteMembers(...)
